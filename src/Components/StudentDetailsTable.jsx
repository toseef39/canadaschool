...
import { FiFilter, FiSearch, FiRefreshCw, FiEye, FiEdit2, FiTrash2 } from "react-icons/fi";
      ...
      
    {
      ...
      cell: (row) => (
        <Input
          ...
          className={`form-select-sm border-2 border-${statusColors[row.status || "In Progress"]} bg-light`}
        >
...
// console.log(filteredData.filter((item)=> item.status === "Certified"),"filteredData")
// console.log(filteredData.filter((item)=> item.status === "In Progress"),"filteredData")
  // console.log(filteredData.filter((item)=> item.status === "Incomplete"),"filteredData")
            ...
            <div className="d-flex align-items-center">
              <Dropdown isOpen={dropdownOpen} toggle={toggleDropdown}>
                ...
                <DropdownMenu>
                  ...
                  <DropdownItem onClick={() => setStatusFilter("In Progress")}>
                    In Progress
                  </DropdownItem>
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                <div className="ps-3">
                  ...
                  <p><strong>Package No:</strong> {selectedStudent.packageNo}</p>
                  <p><strong>Instructor:</strong> {selectedStudent.instructor}</p>
                  <p>
                    <strong>Status:</strong>{" "}
                    <Badge color={statusColors[selectedStudent.status || "In Progress"]}>
              ...
              <div className="col-md-6 mb-3">
                ...
                <div className="ps-3">
                  <p><strong>Payment:</strong> ${selectedStudent.payment || 0}</p>
                  <p><strong>Remaining:</strong> ${selectedStudent.remainingPayment || 0}</p>
                </div>
              </div>
              <div className="col-md-6 mb-3">
                <h6 className="text-muted">Additional Information</h6>
                <div className="ps-3">
                  <p><strong>Road Test:</strong> {selectedStudent.roadTest || "N/A"}</p>
                  <p><strong>License:</strong> {selectedStudent.license || "N/A"}</p>
                  <p><strong>Notes:</strong> {selectedStudent.notes || "None"}</p>
                </div>
              </div>
            </div>
          )}
